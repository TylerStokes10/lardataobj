...
inline const std::vector<float>& anab::CosmicTag::EndPoint1() const
{
  return endPt1;
}
inline const std::vector<float>& anab::CosmicTag::EndPoint2() const
{
  return endPt2;
}
inline const float& anab::CosmicTag::CosmicScore() const
{
  return fCosmicScore;
}
inline const anab::CosmicTagID_t& anab::CosmicTag::CosmicType() const
{
  return fCosmicType;
}
