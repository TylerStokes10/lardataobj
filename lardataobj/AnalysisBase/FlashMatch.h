...
inline const double& anab::FlashMatch::Chi2() const
{
  return fChi2;
}
inline const int& anab::FlashMatch::FlashID() const
{
  return fFlashID;
}
inline const int& anab::FlashMatch::SubjectID() const
{
  return fSubjectID;
}
inline const bool& anab::FlashMatch::InBeam() const
{
  return fInBeam;
}
