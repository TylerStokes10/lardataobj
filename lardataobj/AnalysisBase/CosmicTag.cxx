...
namespace anab {
  ...
  //----------------------------------------------------------------------
  CosmicTag::CosmicTag()
    : endPt1(0), endPt2(0), fCosmicScore(0), fCosmicType(CosmicTagID_t::kUnknown)
  {}

  //----------------------------------------------------------------------
  CosmicTag::CosmicTag(float f)
    : endPt1(0), endPt2(0), fCosmicScore(f), fCosmicType(CosmicTagID_t::kUnknown)
  {}
  ...
  CosmicTag::CosmicTag(std::vector<float> ePt1,
                       ...
                       float cScore,
                       CosmicTagID_t cType)
    : endPt1(ePt1), endPt2(ePt2), fCosmicScore(cScore), fCosmicType(cType)
  {}
  ...
  float CosmicTag::getXInteraction(float oldX,
                                   float xDrift,
                                   int tSample,
                                   float realTime,
                                   int tick) const
