  ...
  namespace flags {
    ...
    namespace details {
      ...
      struct FirstUnsignedTypeNoSmallerThanImpl<NBits, TestType, Others...> {
        ...
        using type =
          std::conditional_t<(sizeof(unsigned_test_type) * 8 >= NBits),
                             unsigned_test_type,
      ...
      struct FirstUnsignedTypeNoSmallerThan {
        ...
        using type = typename FirstUnsignedTypeNoSmallerThanImpl<NBits, TestTypes...>::type;
      ...
      struct SmallestUIntType {
        ...
        using type = typename FirstUnsignedTypeNoSmallerThan<NBits,
                                                             char,
                                                             short int,
                                                             int,
                                                             long int,
      ...
      {
        return 1 + ((sizeof(Storage) * 8 >= bits) ? 0 : computePages<Storage>(bits - 8));
      }
      ...
      //------------------------------------------------------------------------
      template <typename Storage>
      char flagChar(BitMask<Storage> const& flags,
      ...
      createMaskImpl(util::flags::BitMask<Storage> const baseMask, First first, Others... others)
      {
        return createMaskImpl(util::flags::BitMask<Storage>::mergeIntoMask(baseMask, first),
                              others...);
      }
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr util::flags::Bits_t<Storage> util::flags::Bits_t<Storage>::combine(This_t bits) const
{
  return This_t(Storage_t(data | bits.data));
}

template <typename Storage>
constexpr util::flags::Bits_t<Storage> util::flags::Bits_t<Storage>::select(This_t bits) const
{
  return This_t(Storage_t(data & bits.data));
}

template <typename Storage>
constexpr util::flags::Bits_t<Storage> util::flags::Bits_t<Storage>::exclude(This_t bits) const
{
  return select(bits.invert());
}

template <typename Storage>
constexpr util::flags::Bits_t<Storage> util::flags::Bits_t<Storage>::invert() const
{
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr util::flags::Bits_t<Storage> util::flags::operator|(util::flags::Bits_t<Storage> left,
...
template <typename Storage>
constexpr util::flags::Bits_t<Storage> util::flags::operator|(util::flags::Flag_t<Storage> left,
...
constexpr util::flags::BitMask<Storage>::BitMask(BitMaskFromValuesTag,
                                                 Bits_t defined,
                                                 Bits_t values)
  : values(values), presence(defined.combine(values))
{}

template <typename Storage>
constexpr util::flags::BitMask<Storage>::BitMask(BitMaskFromValuesTag tag, Bits_t bits)
  : BitMask(tag, bits, bits)
{}

template <typename Storage>
constexpr util::flags::BitMask<Storage>::BitMask(BitMaskFromValuesTag tag,
                                                 Storage_t defined,
                                                 Storage_t values)
...
template <typename Storage>
constexpr util::flags::BitMask<Storage>::BitMask(BitMaskFromValuesTag tag, Storage_t values)
...
{
  return !definedOnly().select(mask.definedOnly()).empty() ||
...
constexpr typename util::flags::BitMask<Storage>::Mask_t util::flags::BitMask<Storage>::create(
  Args... args)
{
...
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::mergeIntoMask(Mask_t baseMask, Mask_t mask)
{
...
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::mergeIntoMask(Mask_t baseMask, Bits_t bits)
{
  return Mask_t(fromValues, baseMask.presence.combine(bits), baseMask.values.combine(bits));
} // util::flags::BitMask<>::mergeIntoMask(Mask_t)

//------------------------------------------------------------------------------
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::mergeIntoMask(Mask_t baseMask, Flag_t flags)
{
...
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::combineWithMask(Mask_t A, Mask_t B)
{
  return Mask_t(fromValues,
...
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::combineWithMask(Mask_t baseMask, Bits_t bits)
{
...
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::combineWithMask(Mask_t baseMask, Flag_t flags)
{
...
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::intersectWithMask(Mask_t A, Mask_t B)
{
  //
  ...
  return Mask_t(fromValues,
                ...
                A.presence.select(B.presence)
                  .select(A.values)
                  .select(B.values)
                  // the bits that are not, are copied:
                  .combine(A.values.combine(B.values).exclude(A.presence.select(B.presence))));
}

//------------------------------------------------------------------------------
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::intersectWithMask(Mask_t baseMask, Bits_t bits)
{
  ...
  return Mask_t(fromValues,
                ...
                // the bits that are defined in both get AND'ed:
                baseMask.presence.select(bits)
                  .select(baseMask.values)
                  // the bits that are not, are copied:
                  .combine(baseMask.values.combine(bits).exclude(baseMask.presence.select(bits))));
} // util::flags::BitMask<>::intersectWithMask(Mask_t)

//------------------------------------------------------------------------------
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t
util::flags::BitMask<Storage>::intersectWithMask(Mask_t baseMask, Flag_t flags)
{
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t util::flags::BitMask<Storage>::unsetMask(
  Mask_t baseMask,
  Mask_t mask)
{
  return Mask_t(
    fromValues,
    baseMask.presence.combine(mask.presence),
    baseMask.presence.combine(mask.presence).select(baseMask.values.exclude(mask.values)));
}
...
constexpr typename util::flags::BitMask<Storage>::Mask_t util::flags::BitMask<Storage>::unsetMask(
  ...
  Bits_t bits)
{
  return Mask_t(fromValues, baseMask.presence.combine(bits), baseMask.values.exclude(bits));
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr typename util::flags::BitMask<Storage>::Mask_t util::flags::BitMask<Storage>::negateMask(
  Mask_t mask)
{
  return Mask_t(fromValues, mask.presence, mask.presence.select(mask.values.invert()));
}
...
//---
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::makeMask(Bits_t<Storage> bits)
{
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator|(BitMask<Storage> left,
...
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator|(
  typename BitMask<Storage>::Bits_t left,
  BitMask<Storage> right)
{
...
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator&(Bits_t<Storage> left,
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator+(BitMask<Storage> baseMask,
...
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator+(
  typename BitMask<Storage>::Bits_t baseBits,
  BitMask<Storage> mask)
{
...
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator-(Bits_t<Storage> baseBits,
                                                               Bits_t<Storage> bits)
{
...
//------------------------------------------------------------------------------
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator+(BitMask<Storage> mask)
{
  return mask;
}

template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator+(Bits_t<Storage> bits)
{
...
template <typename Storage>
constexpr util::flags::BitMask<Storage> util::flags::operator-(Flag_t<Storage> flag)
{
...
{
  return BitMask<Storage>(BitMask<Storage>::fromValues, flag, Bits_t<Storage>(0));
}
