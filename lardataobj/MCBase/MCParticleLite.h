...
namespace sim {
  ...
  public:
    ...
    {
      if (!this->HasDaughter(d)) _daughters.push_back(d);
    }
  ...
  protected:
    ...
    TLorentzVector _start_vtx{
      TLorentzVector(kINVALID_DOUBLE, kINVALID_DOUBLE, kINVALID_DOUBLE, kINVALID_DOUBLE)};
    TLorentzVector _start_mom{TLorentzVector(kINVALID_DOUBLE,
                                             kINVALID_DOUBLE,
                                             kINVALID_DOUBLE,
                                             kINVALID_DOUBLE)}; ///< Start momentum in GeV
    TLorentzVector _end_vtx{
      TLorentzVector(kINVALID_DOUBLE, kINVALID_DOUBLE, kINVALID_DOUBLE, kINVALID_DOUBLE)};
    TLorentzVector _end_mom{TLorentzVector(kINVALID_DOUBLE,
                                           kINVALID_DOUBLE,
                                           kINVALID_DOUBLE,
                                           kINVALID_DOUBLE)}; ///< End momentum in GeV
