  ...
  */
  ...
  protected:
    ...
    std::vector<std::vector<double>>
      fdQdx; //< the G4 electron yeild per plane between each step // [N Plane][MCSteps - 1]
    std::vector<double>
      fdEdx; //< the G4 "ionization" energy loss between each step // [MCSteps - 1]
