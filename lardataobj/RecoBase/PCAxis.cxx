...
namespace recob {
  ...
  PCAxis::PCAxis(bool ok,
                 ...
                 size_t id)
    : fSvdOK(ok), fNumHitsUsed(nHits), fEigenVectors(eigenVecs), fAveHitDoca(aveHitDoca), fID(id)
  {
  ...
  std::ostream& operator<<(std::ostream& o, const PCAxis& a)
  {
    if (a.fSvdOK) {
      ...
      o << "   - center position: " << std::setw(6) << a.fAvePosition[0] << ", "
        << a.fAvePosition[1] << ", " << a.fAvePosition[2] << std::endl;
      ...
      o << "   - Principle axis: " << std::setw(7) << std::setprecision(4) << a.fEigenVectors[0][0]
        << ", " << a.fEigenVectors[0][1] << ", " << a.fEigenVectors[0][2] << std::endl;
      o << "   - second axis:    " << std::setw(7) << std::setprecision(4) << a.fEigenVectors[1][0]
        << ", " << a.fEigenVectors[1][1] << ", " << a.fEigenVectors[1][2] << std::endl;
      o << "   - third axis:     " << std::setw(7) << std::setprecision(4) << a.fEigenVectors[2][0]
        << ", " << a.fEigenVectors[2][1] << ", " << a.fEigenVectors[2][2] << std::endl;
    }
    else
