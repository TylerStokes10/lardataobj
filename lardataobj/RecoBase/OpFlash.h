...
inline double recob::OpFlash::Time() const
{
  return fTime;
}
inline double recob::OpFlash::TimeWidth() const
{
  return fTimeWidth;
}
inline double recob::OpFlash::AbsTime() const
{
  return fAbsTime;
}
inline unsigned int recob::OpFlash::Frame() const
{
  return fFrame;
}
inline double recob::OpFlash::PE(unsigned int i) const
{
  return fPEperOpDet[i];
}
inline std::vector<double> const& recob::OpFlash::PEs() const
{
  return fPEperOpDet;
}
inline bool recob::OpFlash::hasXCenter() const
{
  return fXCenter != NoCenter;
}
inline double recob::OpFlash::XCenter() const
{
  return fXCenter;
}
inline double recob::OpFlash::XWidth() const
{
  return fXWidth;
}
inline double recob::OpFlash::YCenter() const
{
  return fYCenter;
}
inline double recob::OpFlash::YWidth() const
{
  return fYWidth;
}
inline double recob::OpFlash::ZCenter() const
{
  return fZCenter;
}
inline double recob::OpFlash::ZWidth() const
{
  return fZWidth;
}
inline double recob::OpFlash::FastToTotal() const
{
  return fFastToTotal;
}
inline std::vector<double> const& recob::OpFlash::WireCenters() const
{
  return fWireCenters;
}
inline std::vector<double> const& recob::OpFlash::WireWidths() const
{
  return fWireWidths;
}
inline bool recob::OpFlash::InBeamFrame() const
{
  return fInBeamFrame;
}
inline int recob::OpFlash::OnBeamTime() const
{
  return fOnBeamTime;
}
