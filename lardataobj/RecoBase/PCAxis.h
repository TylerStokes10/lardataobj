...
inline bool recob::PCAxis::getSvdOK() const
{
  return fSvdOK;
}
inline int recob::PCAxis::getNumHitsUsed() const
{
  return fNumHitsUsed;
}
inline const double* recob::PCAxis::getEigenValues() const
{
  return fEigenValues;
}
inline const recob::PCAxis::EigenVectors& recob::PCAxis::getEigenVectors() const
{
  return fEigenVectors;
}
inline const double* recob::PCAxis::getAvePosition() const
{
  return fAvePosition;
}
inline double recob::PCAxis::getAveHitDoca() const
{
  return fAveHitDoca;
}
inline size_t recob::PCAxis::getID() const
{
  return fID;
}
