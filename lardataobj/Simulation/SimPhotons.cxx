...
// ---  sim::SimPhotonsLite
// -----------------------------------------------------------------------------
sim::SimPhotonsLite& sim::SimPhotonsLite::operator+=(const sim::SimPhotonsLite& rhs)
{
...
//----------------------------------------------------------------------------
sim::SimPhotonsLite sim::SimPhotonsLite::operator+(const sim::SimPhotonsLite& rhs) const
{
